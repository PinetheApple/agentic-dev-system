"""Runtime prompt composition (ticket 002): base + expert + design + task, in memory.
...
section headers so the model can tell the layers apart.
"""

from __future__ import annotations


def compose(base: str, expert_body: str, design: str, task_body: str) -> str:
