...
For implementation tasks, set `"expert": "coder"` — the general-purpose
implementation expert works in whatever language/framework this repository
already uses. Only use another expert name if this config tree defines one.
